...
const MillaPage = () => (
  <div className={pageContainer}>
    ...
    <div className={contentContainer}>
      ...
      <p>
        Read the full <a href="https://drive.google.com/file/d/1iKaMlSIUKE6QL5bVjf-TkTCk6UC-VIkI/view?usp=sharing" target="_blank" rel="noreferrer">Competitive Analysis</a>(PDF).</p>
      <h1>User Interviews</h1>
      <p>Read full <a href="https://drive.google.com/file/d/14yg-2-FO-7VL4wyd1VFpZ2A_OyY64TD8/view?usp=sharing" target="_blank" rel="noreferrer">User Interview Process and Analysis</a>(PDF).</p>
      ...
      <p>Read the full <a href="https://drive.google.com/file/d/1UibnHX7BjybTPz-591oKU-_B0CfJTGu9/view?usp=sharing" target="_blank" rel="noreferrer">Usability Test Plan</a>(PDF) which includes scope, schedule, metrics, script, and participant notes.</p>
      ...
      <div style={{display: "flex", justifyContent: "center"}}>
        <a href={"https://marvelapp.com/prototype/14e28chj/screen/78699185"} target="_blank" rel="noreferrer"><img style={{width: "30vw"}} src={prototype}></img></a>
      </div>
      <h1>Summary</h1>
